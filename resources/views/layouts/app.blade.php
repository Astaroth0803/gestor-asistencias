...
<body>
    ...
    <nav class="navbar" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
         ...
         <span >Centro Juvenil y Biblioteca las Mañanitas</span>
        ...
        <div id="navbarBasicExample" class="navbar-menu">
          <div class="navbar-end ">
            ...
            <a class="navbar-item" href="{{ route('asistencias.index') }}">
                Asistencias
              </a>
            <a class="navbar-item" href="{{ route('actividades.index') }}">
                Actividades
              </a>
          </div>
        </div>
...
$(".navbar-burger").click(function() {
   ...
   <footer style="color: #fff; text-align: center; padding: 1rem;">
    <p>© 2024 Angel DevOp Solutions. Todos los derechos reservados.</p>
</footer>
